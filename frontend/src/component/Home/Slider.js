...
export default function Slider() {
  return (
    <>
      ...
      >
        <SwiperSlide>
          <img src={img1} height="500" style={{ width: "100%" }} />
        </SwiperSlide>
        <SwiperSlide>
          <img src={img2} height="500" style={{ width: "100%" }} />
        </SwiperSlide>
        <SwiperSlide>
          <img src={img3} height="500" style={{ width: "100%" }} />
        </SwiperSlide>
        <SwiperSlide>
          <img src={img4} height="500" style={{ width: "100%" }} />
        </SwiperSlide>
        <SwiperSlide>
          <img
            src={img5}
